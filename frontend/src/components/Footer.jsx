    ...
    <div className='md:mx-10'>
      <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10  mt-40 text-sm'>
        ...
        <div>
          ...
          <p className='w-full md:w-2/3 text-gray-600 leading-6'>With Prescripto, booking an appointment is just a few clicks away—eliminating long waiting times and ensuring you get the care you need, when you need it. Whether you're looking for general practitioners, specialists, or diagnostic services, Prescripto empowers you to take control of your health with confidence and convenience.</p>
        </div>
